...
[Serializable]
public class RainSceneDepthRenderData : ScriptableRendererData
{

#if UNITY_EDITOR
    internal class CreateRainSceneDepthRenderAsset : EndNameEditAction
    {
        public override void Action(int instanceId, string pathName, string resourceFile)
        {
            var instance = CreateInstance<RainSceneDepthRenderData>();
    ...
    {
        return new RainSceneDepthRender(this);
    }
}
