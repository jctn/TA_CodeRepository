Shader "Code Repository/ParticleCloud/MatCapSpher_Lighting"
{
    Properties
    {
        ...
        _ParticleCloudAmbientColor("_ParticleCloudAmbientColor",Color) = (1,1,1,1)
    }
    SubShader
    {
        Tags
        ...
        Pass
        {
            ...
            half4 _BaseColor;
            half4 _ParticleCloudAmbientColor;
            float4x4 _MVPMatrix;
            float4x4 _MMatrix;
            CBUFFER_END
            ...
            half4 frag(Varings IN):SV_Target
            {
                ...
                half3 color = diffuse * _BaseColor.xyz + _ParticleCloudAmbientColor.rgb;
